...
#
# Script generated by Vivado on Wed Jun 17 16:35:09 +0800 2026
...
export RDI_DATADIR="E:/Vivado25/2025.2.1/Vivado/data"
...
# script info
echo -e "DRAM.sh - Script generated by export_simulation (Vivado v2025.2.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DRAM xil_defaultlib.DRAM xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/Vivado25/2025.2.1/Vivado/data/xsim"
  fi
