...
module Hazard(
    ...
    assign pc_stall         = (stall_by_load_use || stall_by_load_use_r||stall_by_muldiv) && !mispredicted;
    assign IF1_IF2_stall    = (stall_by_load_use || stall_by_load_use_r||stall_by_muldiv) && !mispredicted;
    assign IF2_ID_stall     = (stall_by_load_use || stall_by_load_use_r||stall_by_muldiv) && !mispredicted;
    assign ID_EX_stall      = (stall_by_load_use_r||stall_by_muldiv) && !mispredicted;
