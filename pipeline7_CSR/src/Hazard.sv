...
module Hazard(
    ...
    assign EX_LS1_flush     = flush_by_exp;
    assign LS1_LS2_flush    = flush_by_exp;
    assign LS2_WB_flush     = flush_by_exp;

    assign pc_stall         = (stall_by_load_use || stall_by_load_use_r) && !mispredicted;
    assign IF1_IF2_stall    = (stall_by_load_use || stall_by_load_use_r) && !mispredicted;
    assign IF2_ID_stall     = (stall_by_load_use || stall_by_load_use_r) && !mispredicted;
    assign ID_EX_stall      = stall_by_load_use_r && !mispredicted;
