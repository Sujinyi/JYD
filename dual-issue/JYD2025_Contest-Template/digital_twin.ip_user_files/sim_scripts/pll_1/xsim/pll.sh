...
#
# Script generated by Vivado on Tue Mar 17 10:33:30 +0800 2026
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 16  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot pll xil_defaultlib.pll xil_defaultlib.glbl -log elaborate.log
}
