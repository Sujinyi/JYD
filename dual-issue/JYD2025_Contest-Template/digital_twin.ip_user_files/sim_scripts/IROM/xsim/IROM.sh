...
#
# Script generated by Vivado on Tue Mar 17 15:33:20 +0800 2026
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 16  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot IROM xil_defaultlib.IROM xil_defaultlib.glbl -log elaborate.log
}
