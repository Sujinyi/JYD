...
#
# Script generated by Vivado on Mon Mar 09 19:39:47 +0800 2026
...
# script info
echo -e "DRAM.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L dist_mem_gen_v8_0_15 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DRAM xil_defaultlib.DRAM xil_defaultlib.glbl -log elaborate.log
}
