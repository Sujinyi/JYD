...
module perip_bridge #(
    parameter DRAM_MEM = "dram.mem"   // added: init-file passthrough for RTL DRAM
) (
    input  logic         clk,
    input  logic         cnt_clk,
    input  logic         rst,
    ...
    // added: DRAM port-B passthrough (slot1 read-only load port)
    input  logic [15:0]  dram_addrb,
    input  logic [3:0]   dram_web,
    input  logic [31:0]  dram_dinb,
    output logic [31:0]  dram_doutb,
