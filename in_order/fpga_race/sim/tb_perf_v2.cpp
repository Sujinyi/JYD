...
int main(int argc, char **argv) {
    ...
    Seg segs[] = {
        {"whole_irom_v2", 0x00000000, 0xffffffff},
    };
    ...
    printf("%-14s %10s %8s %6s | %6s %6s %6s | %6s %6s %6s %6s %6s %6s %6s | %6s %6s %6s %6s\n",
           "segment", "cycles", "instrs", "CPI",
           "ldhz", "strct", "dep",
           "mstal", "br", "jalr", "cold", "fetch", "nov1", "ctrl",
    ...
    for (int i = 0; i < NSEG; i++) {
        ...
        printf("%-14s %10lu %8lu %6.3f | %6.3f %6.3f %6.3f | %6.3f %6.3f %6.3f %6.3f %6.3f %6.3f %6.3f | %6.3f %6.3f %6.3f %6.3f\n",
               s.name, (unsigned long)s.cycles, (unsigned long)inst,
               (double)s.cycles / (double)inst,
               s.l_hz / di, s.s_struct / di, s.s_dep / di,
               s.l_ms / di, s.l_br / di, s.l_jr / di, s.l_cold / di,
               s.l_fetch / di, s.s_nov1 / di, (s.s_ctrl + s.s_hz1) / di,
