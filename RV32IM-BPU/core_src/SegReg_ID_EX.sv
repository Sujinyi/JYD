module SegReg_ID_EX#(
    ...
    input  logic [ 0:0] is_muldiv_id,
    input  logic [ 2:0] muldiv_op_id,

    output logic [ 0:0] is_muldiv_ex,
    output logic [ 2:0] muldiv_op_ex,
    ...
    always_ff @(posedge clk) begin
        if(rst) begin
            ...
            if(!stall) begin
                ...
                is_muldiv_ex    <= is_muldiv_id;
                muldiv_op_ex    <= muldiv_op_id;
            end
        end
    end
