...
module CPU#(
    ...
    wire  [ 2:0]    priv_vec_ex_valid = have_inst_ex ? priv_vec_ex : 3'h0;
    wire  [ 2:0]    priv_vec_wb_valid = have_inst_wb ? priv_vec_wb : 3'h0;
    wire  [ 0:0]    rf_we_wb_valid = rf_we_wb && have_inst_wb;
    wire  [ 0:0]    jump_valid = jump && have_inst_ex;

    //MulDiv related
    logic [ 2:0]    muldiv_op_id, muldiv_op_ex;
    logic [ 0:0]    is_muldiv_id, is_muldiv_ex;
    logic [ 0:0]    muldiv_busy, muldiv_done;
    ...
    BPU BPU_inst (
        ...
        .update_is_ret  (is_ret_ex),
        .ras_push       (ras_push_ex),
        .ras_pop        (ras_pop_ex),
        .ras_push_addr  (ras_push_addr_ex)
    );
    ...
    Decode  Decode_inst (
        ...
        .is_muldiv        (is_muldiv_id),
        .muldiv_op        (muldiv_op_id)
    );
    ...
    SegReg_ID_EX # (
        ...
        .is_muldiv_id      (is_muldiv_id),
        .muldiv_op_id     (muldiv_op_id),
        .is_muldiv_ex      (is_muldiv_ex),
        .muldiv_op_ex     (muldiv_op_ex),
    ...
    logic [31:0] muldiv_result_ex;
    wire muldiv_start = have_inst_ex && is_muldiv_ex && !muldiv_busy && !muldiv_done;
    MulDiv MulDiv_inst (
        .clk            (cpu_clk),
        .rst            (cpu_rst),
        .valid          (have_inst_ex && is_muldiv_ex),
        .start          (muldiv_start),
        .op             (muldiv_op_ex),
        .a              (alu_rs1),
        .b              (alu_rs2),
    ...
    assign ex_result = is_muldiv_ex ? muldiv_result_ex : alu_result_ex;
    Priv  Priv_inst (
    ...
    assign bus_wen = have_inst_ls1 ? d_wstrb : 4'h0;
    ...
    Hazard  Hazard_inst (
        ...
        .rf_we_ls1           (rf_we_ls1 && have_inst_ls1),
        .rf_we_ls2           (rf_we_ls2 && have_inst_ls2),
        .rf_we_wb            (rf_we_wb_valid),
        ...
        .mem_access_ex      (have_inst_ex ? mem_access_ex : `NO_ACCESS),
        ...
        .is_muldiv_ex        (have_inst_ex && is_muldiv_ex),
    ...
    assign debug_wb_ena       = rf_we_wb_valid;
