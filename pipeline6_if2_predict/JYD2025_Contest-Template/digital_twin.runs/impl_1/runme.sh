...
HD_PWD='C:/Users/21186/Desktop/verify/pipeline6_if2_predict/JYD2025_Contest-Template/digital_twin.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log student_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source student_top.tcl -notrace
