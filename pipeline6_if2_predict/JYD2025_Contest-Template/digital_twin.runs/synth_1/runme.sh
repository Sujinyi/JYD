...
HD_PWD='C:/Users/21186/Desktop/verify/pipeline6_if2_predict/JYD2025_Contest-Template/digital_twin.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log student_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source student_top.tcl
